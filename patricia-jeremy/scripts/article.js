...
Article.prototype.toHtml = function() {
  ...
  // This is a ternary operator that is checking if the article has been published. If true, it publishes 'this'. If false, it publishes 'this'. the ? serves as the if operator, and the colon returns the false conditional. Previously, this was represented using if/else statements.
